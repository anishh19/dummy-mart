...
function HomePageContent() {
  ...
  return (
    <div className="relative w-full overflow-x-hidden" >
        <button id="prevSlide" onClick={()=>prevSlide()} className="absolute h-56 md:h-56 left-0 z-10 hover:border-2 rounded">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="White" className="w-10 h-10">
          <path fillRule="evenodd" d="M7.72 12.53a.75.75 0 010-1.06l7.5-7.5a.75.75 0 111.06 1.06L9.31 12l6.97 6.97a.75.75 0 11-1.06 1.06l-7.5-7.5z" clipRule="evenodd" />
          </svg>
        </button>
        <button id="nextSlide"  onClick={()=>nextSlide()} className="absolute h-56 md:h-56 right-0 z-10 hover:border-2 rounded">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="white" className="w-10 h-10">
