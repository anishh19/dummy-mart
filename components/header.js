  ...
  function handleChange(e){
    ...
    return (
      <div className='flex justify-evenly md:justify-between md:py-3 text-xl gap-2 bg-gray-800 w-full pt-2 pr-4 text-white'>
          <Link href="/">
          <div className='text-2xl align-middle md:text-4xl p-1'>
              DummyMart
          </div>
          </Link>
          <form className='w-2/5 md:pl-0 md:h-10 h-8 flex flex-row align-center justify-between '>
            ...
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="black"  className='bg-white h-8 w-8 md:h-10 md:h-10  rounded-r-xl'>
