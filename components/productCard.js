...
function ProductCard(props) {
  ...
  if(isWished){
    ...
    <svg id="heart" 
    onClick={() => {toggleHeart()}} 
    xmlns="http://www.w3.org/2000/svg" fill="red" viewBox="0 0 24 24" strokeWidth={1.5} stroke="red" className="w-6 h-6">
  ...
  return (
    ...
    <div className="border-solid border-8 bg-gray-200 max-h-64 rounded-xl" key={props.id}>
