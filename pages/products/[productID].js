...
function Products( {data} ) {
  const dispatch = useDispatch();
    return (
        ...
        <div className="p-8 md:p-16 grid grid-cols-1 md:grid-cols-2 h-[80vh]">
            <div className="flex h-44 md:h-80 md:w-1/2 justify-centre p-4 relative">
            ...
            <div className="p-4 flex flex-col h-full justify-between">
              ...
              <button onClick={() => dispatch(addToCart(data))} className= "w-full md:w-3/4 py-4 bg-yellow-400 rounded-full flex flex-row justify-center hover:bg-yellow-500">
                <div className="px-4">
